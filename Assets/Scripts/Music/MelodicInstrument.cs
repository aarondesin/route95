...
namespace Route95.Music {
    ...
    public class MelodicInstrument : Instrument {
        ...
        public static MelodicInstrument ElectricGuitar = new MelodicInstrument {
            ...
            _iconPath = "Sprites/Instrument_ElectricGuitar",
            _glowPath = "Sprites/Instrument_ElectricGuitar_Glow",
        ...
        public static MelodicInstrument ElectricBass = new MelodicInstrument {
            ...
            _type = Type.Melodic,
            _family = Family.Bass,
            _iconPath = "Sprites/Instrument_ElectricBass",
            _glowPath = "Sprites/Instrument_ElectricBass_Glow",
        ...
        public static MelodicInstrument AcousticGuitar = new MelodicInstrument {
            ...
            _type = Type.Melodic,
            _family = Family.Guitar,
            _iconPath = "Sprites/Instrument_AcousticGuitar",
            _glowPath = "Sprites/Instrument_AcousticGuitar_Glow",
            _switchSoundPath = "Audio/Gameplay/Instruments/ElectricGuitar",
            _startingNote = new Dictionary<Key, int>() {
                { Key.C, 8 },
                { Key.CSharp, 9 },
        ...
        public static MelodicInstrument ClassicalGuitar = new MelodicInstrument {
            ...
            _type = Type.Melodic,
            _family = Family.Guitar,
            _iconPath = "Sprites/Instrument_ClassicalGuitar",
            _glowPath = "Sprites/Instrument_ClassicalGuitar_Glow",
            _switchSoundPath = "Audio/Gameplay/Instruments/ElectricGuitar",
            _startingNote = new Dictionary<Key, int>() {
                { Key.C, 8 },
                { Key.CSharp, 9 },
        ...
        public static MelodicInstrument PipeOrgan = new MelodicInstrument {
            ...
            _iconPath = "Sprites/Instrument_PipeOrgan",
            _glowPath = "Sprites/Instrument_PipeOrgan_Glow",
            _switchSoundPath = "Audio/Gameplay/Instruments/ElectricGuitar",
            _startingNote = new Dictionary<Key, int>() {
                { Key.C, 3 },
                { Key.CSharp, 4 },
        ...
        public static MelodicInstrument Keyboard = new MelodicInstrument {
            ...
            _type = Type.Melodic,
            _family = Family.Keyboard,
            _iconPath = "Sprites/Instrument_Keyboard",
            _glowPath = "Sprites/Instrument_Keyboard_Glow",
            _switchSoundPath = "Audio/Gameplay/Instruments/ElectricGuitar",
            _startingNote = new Dictionary<Key, int>() {
                { Key.C, 3 },
                { Key.CSharp, 4 },
        ...
        public static MelodicInstrument Trumpet = new MelodicInstrument {
            ...
            _iconPath = "Sprites/Instrument_Trumpet",
            _glowPath = "Sprites/Instrument_Trumpet_Glow",
            _switchSoundPath = "Audio/Gameplay/Instruments/ElectricGuitar",
            _startingNote = new Dictionary<Key, int>() {
                { Key.C, 3 },
                { Key.CSharp, 4 },
